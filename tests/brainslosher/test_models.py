from brainwasher.brainslosher_models import BrainSlosherJob, BrainSlosherConfig, Cycle
import pytest
...
def test_required_keys():
    ...
    with pytest.raises(ValidationError) as e:
        BrainSlosherConfig(selector_port_map={},
    ...
    with pytest.raises(ValidationError) as e:
        BrainSlosherConfig(selector_port_map={"air":0, "chamber":1},
                           drain_volume_buffer_ml=2,
                           fill_volume_ml=5
                           )
    error_str = str(e.value)
    ...
    BrainSlosherConfig(selector_port_map={"air":0, "chamber":1, "waste":2},
                        drain_volume_buffer_ml=2,
                        fill_volume_ml=5
                        )
